      ...
      <div className="p-6 flex-grow">
        <div className="flex justify-between items-center mb-6">
          ...
          <span className={`px-2 py-0.5 text-[10px] font-bold uppercase tracking-tighter ${
            data.severity === 'High Intensity' ? 'bg-red-600 text-white' : 'bg-orange-500 text-black'
          }`}>
            {data.severity}
          </span>
        </div>
        ...
        <a 
          ...
          className="inline-block text-[10px] text-red-500 font-bold uppercase tracking-widest border-b border-red-500 pb-1 hover:text-white hover:border-white transition-all"
        >
